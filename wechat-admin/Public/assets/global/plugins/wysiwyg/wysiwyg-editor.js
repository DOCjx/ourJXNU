(function(window, document, $, undefined){
                                  ...
                                  placeholder_url, max_imagesize, onImageUpload, onKeyEnter )
    {
        ...
        if( wysiwygeditor.legacy )
        {
            ...
            var text1 = "请输入单位介绍，5000字以内";
            $(wysiwygeditor.getElement()).addClass( 'wysiwyg-editor' ).text(text1).on('focus',function(){
                if ($(this).text() == text1) $(this).text("");
            }).on('blur',function(){
                if ($(this).text() == "") $(this).text(text1);
            });
        }
